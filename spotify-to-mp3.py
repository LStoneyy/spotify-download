    ...
    with Progress() as progress:
        ...
        for track in tracks:
            ...
            if artist:
                ...
                console.print(f"[cyan]Searching with artist: {search_query}[/cyan]")
            else:
                search_query = f"{title} official audio"
                console.print(f"[cyan]Searching without artist: {search_query}[/cyan]")
            ...
            if youtube_url:
                ...
                console.print(f"[cyan]Alternative search: {alt_search_query}[/cyan]")
                ...
                if youtube_url:
                    ...
                    if success:
                        ...
                        if artist:
                            ...
                            console.print(f"[cyan]Last search with artist and title start: {final_search_query}[/cyan]")
                            ...
                            if youtube_url:
                                ...
                                success = download_mp3(youtube_url, output_dir, track, quality)
                                if success:
                                    console.print(f"[green]Downloaded with last search: {file_title}[/green]")
                                else:
                                    console.print(f"[yellow]All search attempts failed: {file_title}[/yellow]")
                        else:
                            console.print(f"[yellow]Alternative search failed: {file_title}[/yellow]")
